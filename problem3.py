...
for c in cnts:
	...
	if radius > 20:
		...
		lineX1 = int(x + radius*(vx)*1.1)
		lineY1 = int(y + radius*(vy)*1.1)

		lineX2 = int(x - radius*(vx)*1.1)
		lineY2 = int(y - radius*(vy)*1.1)
		...
		cv2.line(image,(lineX1,lineY1),(lineX2,lineY2),(70,125,180),2)
